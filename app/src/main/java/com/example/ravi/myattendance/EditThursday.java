...
public class EditThursday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState){
        ...
        if(sessionManager.isLoggedIn())
        {
            ...
            if(count>=1)
                thus1.setText(subthu.get(SessionManager.KEY_THU_SUB_1));
            if(count>=2)
                thus2.setText(subthu.get(SessionManager.KEY_THU_SUB_2));
            if(count>=3)
                thus3.setText(subthu.get(SessionManager.KEY_THU_SUB_3));
            if(count>=4)
                thus4.setText(subthu.get(SessionManager.KEY_THU_SUB_4));
            if(count>=5)
                thus5.setText(subthu.get(SessionManager.KEY_THU_SUB_5));
            if(count>=6)
                thus6.setText(subthu.get(SessionManager.KEY_THU_SUB_6));
            if(count>=7)
                thus7.setText(subthu.get(SessionManager.KEY_THU_SUB_7));
