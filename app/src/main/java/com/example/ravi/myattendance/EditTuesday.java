        ...
        if(sessionManager.isLoggedIn())
        {
            ...
            IBAddSub.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    builder.setTitle("Select Subjects for Tuesday");
