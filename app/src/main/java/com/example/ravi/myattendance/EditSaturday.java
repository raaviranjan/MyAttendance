...
public class EditSaturday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState){
        ...
        if(sessionManager.isLoggedIn())
        {
            ...
            if(count>=1)
                sats1.setText(subsat.get(SessionManager.KEY_SAT_SUB_1));
            if(count>=2)
                sats2.setText(subsat.get(SessionManager.KEY_SAT_SUB_2));
            if(count>=3)
                sats3.setText(subsat.get(SessionManager.KEY_SAT_SUB_3));
            if(count>=4)
                sats4.setText(subsat.get(SessionManager.KEY_SAT_SUB_4));
            if(count>=5)
                sats5.setText(subsat.get(SessionManager.KEY_SAT_SUB_5));
            if(count>=6)
                sats6.setText(subsat.get(SessionManager.KEY_SAT_SUB_6));
            if(count>=7)
                sats7.setText(subsat.get(SessionManager.KEY_SAT_SUB_7));
